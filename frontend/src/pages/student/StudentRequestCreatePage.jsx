...
const StudentRequestCreatePage = () => {
  ...
  const handleSend = (e) => {
    ...
    addRequest({
      ...formData,
      workflow: finalTo ? [finalTo] : (selectedCategory ? selectedCategory.defaultWorkflow : ['Faculty', 'HOD']),
    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-neutral-900 dark:text-white">New Request</h1>
            <p className="text-sm text-neutral-500">Fill in the details below to submit a formal request.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-sm overflow-hidden flex flex-col">
        <div className="p-6 md:p-8 space-y-6 flex-1">
          ...
          <div className="space-y-2">
            ...
            >
              <option value="">Default Category Workflow</option>
            ...
            {formData.toRole === 'Specific ID / Email' && (
              <input 
                type="text"
                placeholder="Enter Recipient ID or Email (e.g. FAC101 or admin@svcet.edu)"
            ...
            <p className="text-xs text-neutral-500 mt-1">Leave empty to use the standard approval process, or select a specific role to bypass the workflow and send directly to them.</p>
          </div>
...
export default StudentRequestCreatePage;
